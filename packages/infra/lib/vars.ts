...
export const PRIMARY_DOMAIN = strFromArr(
  [APP, GIT_BRANCH !== "main" && GIT_BRANCH, "apps", baseDomain],
  "."
);

export const STACK_ID = strFromArr(
  [GIT_BRANCH, APP, "skylark-reference-apps"],
  "-"
);
export const STACK_NAME =
  process.env.STACK_NAME || strFromArr(["sl-ref-apps", APP, GIT_BRANCH], "-");
