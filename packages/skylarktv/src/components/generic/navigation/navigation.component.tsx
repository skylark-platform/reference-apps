...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  >
    <ul className="flex h-14 flex-row md:gap-6 lg:gap-8 ltr:md:ml-8 ltr:xl:ml-xl-gutter rtl:md:ml-8 rtl:xl:mr-xl-gutter">
      {links.map((link) => {
        const textAndIcon = (
          <>
        ...
        const className = clsx(
          "text-xl transition-colors flex justify-center items-center hover:text-white md:text-sm max-md:px-8 h-full xl:text-base",
