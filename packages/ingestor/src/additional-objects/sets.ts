...
const fastAndFuriousMoviesCollection: SetConfig = {
  ...
  contents: [
    ...
    { type: "movies", slug: "the-fast-and-the-furious-tokyo-drift" },
    { type: "movies", slug: "fast-furious" },
    { type: "movies", slug: "fast-five" },
    { type: "movies", slug: "fast-furious-6" },
    { type: "movies", slug: "furious-7" },
    { type: "movies", slug: "the-fate-of-the-furious" },
    { type: "movies", slug: "fast-furious-presents-hobbs-shaw" },
    { type: "movies", slug: "f9" },
