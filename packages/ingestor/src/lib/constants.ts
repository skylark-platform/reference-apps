...
export const COGNITO_IDENTITY_POOL_ID = process.env.COGNITO_IDENTITY_POOL_ID as string;
export const AMPLIFY_STORAGE_BUCKET = process.env.AMPLIFY_STORAGE_BUCKET as string;
