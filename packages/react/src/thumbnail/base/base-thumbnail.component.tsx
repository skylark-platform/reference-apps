  ...
  return (
    <div
      ...
      className={`
          ${
            large
              ? "aspect-h-4 aspect-w-3 hover:scale-[1.01] md:hover:scale-[1.03]"
              : "aspect-h-9 aspect-w-16 hover:scale-[1.02] md:hover:scale-105"
          }
          relative z-30 block w-full scale-[1.0001] rounded-sm bg-cover bg-clip-border
          bg-center bg-no-repeat transition-all hover:z-40
