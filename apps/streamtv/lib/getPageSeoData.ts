...
const getSeoTitleAndSynopsis = (data: Entertainment | Article) => {
  ...
  const title = getTitleByOrder({
    title_long: entertainment.title_long || "",
    title_medium: entertainment.title_medium || "",
    title_short: entertainment.title_short || "",
  });

  const synopsis = getSynopsisByOrder({
    synopsis_long: entertainment.synopsis_long || "",
    synopsis_medium: entertainment.synopsis_medium || "",
